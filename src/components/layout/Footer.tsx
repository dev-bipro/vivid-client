  ...
  return (
    <footer className="bg-gray-100 pt-16 pb-8">
      <div className="container mx-auto px-4">
        {/* Features section */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12 border-b border-gray-200 pb-12">
          ...
          <div className="flex flex-col items-center text-center">
            <CreditCard size={32} className="text-primary mb-3" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          <div>
            <h3 className="text-lg font-bold mb-4">VividShop</h3>
        ...
        <div className="border-t border-gray-200 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-600 text-sm">
              © {new Date().getFullYear()} VividShop. All rights reserved.
            </p>
